<script setup>
  ...
  const goToViewNote = (noteToViewId) => {
    router.push('/users/view-note/' + noteToViewId);
  };
...
<template>
  <Head>
    <Title>Nuxt JS Notes App - View Your Notes</Title>
    <Meta name="description" content="View your notes" />
  </Head>
        ...
        <div class="note-card">
          ...
          <div v-else="showLoadingErrorMessage == true" class="error-section">
            ...
            <div v-if="paginatedNotes.length == null">
              ...
              <!--<NuxtLink to="/users/view-notes" class="reload-link">Reload</NuxtLink>-->
