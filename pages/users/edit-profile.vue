<script setup>
    ...
    let updateProfileName = async () => {
        ...
        if (validateUpdateNameForm()) {
            ...
            if (token.value) {
                const url = `${apiUrl}/users/update_profile_name`;
    ...
    let updateProfileEmail = async () => {
        ...
        if (validateUpdateEmailForm()) {
            ...
            if (token.value) {
                const url = `${apiUrl}/users/update_profile_email`;
    ...
    let updateProfilePassword = async () => {
        ...
        if (validateUpdatePasswordForm()) {
            ...
            if (token.value) {
                const url = `${apiUrl}/users/update_profile_password`;
...
<template>
    <Head>
        <Title>Nuxt JS Notes App - Edit Your Profile</Title>
