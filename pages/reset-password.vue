...
<template>
    <Head>
        <Title>Nuxt JS Notes App - Reset Password</Title>
        <Meta name="description" content="Reset your password on Nuxt JS Notes App" />
    </Head>
    ...
    <main class="page auth-page">
        ...
        <form class="auth-form" @submit.prevent="submitResetPassword">
            ...
            <p>Remember your password? <NuxtLink to="/login" class="link">Login</NuxtLink></p>
        </form>
    </main>
</template>
